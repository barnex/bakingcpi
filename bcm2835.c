...
//
// Modified by Arne Vansteenkiste, 2013
...
volatile uint32_t *bcm2835_pads = (volatile uint32_t*) BCM2835_GPIO_PADS;
volatile uint32_t *bcm2835_gpio = (volatile uint32_t*) BCM2835_GPIO_BASE;
volatile uint32_t *bcm2835_st	= (volatile uint32_t*) BCM2835_ST_BASE;
