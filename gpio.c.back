 ...
 */
volatile void* GetGpioAddress(){
	return (volatile void*)(0x20200000);
}
...
/**
 * SetGpioFunction sets the function of the GPIO register addressed by r0
 * to the low  3 bits of r1.
 */
void SetGpioFunction(unsigned int gpioRegister, unsigned int function){
	if (gpioRegister >= 54 || function >= 8) {
		return; // error
	}	
}
